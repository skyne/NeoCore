/* Copyright (C) 2006 - 2008 NeoScript <https://scriptdev2.svn.sourceforge.net/>
...
#define _FULLVERSION "NeoScript"

#ifndef _NEO_SCRIPT_CONFIG
# define _NEO_SCRIPT_CONFIG  "neocore.conf"
#endif _NEO_SCRIPT_CONFIG
...
void Script::RegisterSelf()
{
    ...
    {
        error_db_log("CRASH ALERT! NeoScript: RegisterSelf, but script named %s does not have ScriptName assigned in database.",(this)->Name.c_str());
        delete this;
    }
}
...
{
    return "Default Neo scripting library";
}
NEO_DLL_EXPORT
