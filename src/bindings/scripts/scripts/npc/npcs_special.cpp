...
struct NEO_DLL_DECL npc_chicken_cluckAI : public ScriptedAI
{
...
struct NEO_DLL_DECL npc_doctorAI : public ScriptedAI
{
    uint64 Playerguid;
...
struct NEO_DLL_DECL npc_injured_patientAI : public ScriptedAI
{
...
struct NEO_DLL_DECL npc_guardianAI : public ScriptedAI
{
...
struct NEO_DLL_DECL npc_steam_tonkAI : public ScriptedAI
{
...
struct NEO_DLL_DECL npc_tonk_mineAI : public ScriptedAI
{
