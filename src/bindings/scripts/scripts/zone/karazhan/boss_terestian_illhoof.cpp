...
struct NEO_DLL_DECL mob_kilrekAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_demon_chainAI : public ScriptedAI
{
...
struct NEO_DLL_DECL boss_terestianAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_fiendish_impAI : public ScriptedAI
{
