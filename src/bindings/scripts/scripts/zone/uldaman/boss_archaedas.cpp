...
struct NEO_DLL_DECL boss_archaedasAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_archaedas_minionsAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_stonekeepersAI : public ScriptedAI
{
