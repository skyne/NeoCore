...
struct NEO_DLL_DECL boss_twinemperorsAI : public ScriptedAI
{
...
class NEO_DLL_DECL BugAura : public Aura
{
    public:
...
struct NEO_DLL_DECL boss_veknilashAI : public boss_twinemperorsAI
{
...
struct NEO_DLL_DECL boss_veklorAI : public boss_twinemperorsAI
{
