...
struct NEO_DLL_DECL flesh_tentacleAI : public Scripted_NoMovementAI
{
...
struct NEO_DLL_DECL eye_of_cthunAI : public Scripted_NoMovementAI
{
    eye_of_cthunAI(Creature *c) : Scripted_NoMovementAI(c)
    {
        pInst = (ScriptedInstance*)c->GetInstanceData();
        if (!pInst)
            error_log("NeoScript: No Instance eye_of_cthunAI");
    }
...
struct NEO_DLL_DECL cthunAI : public Scripted_NoMovementAI
{
...
struct NEO_DLL_DECL eye_tentacleAI : public Scripted_NoMovementAI
{
...
struct NEO_DLL_DECL claw_tentacleAI : public Scripted_NoMovementAI
{
...
struct NEO_DLL_DECL giant_claw_tentacleAI : public Scripted_NoMovementAI
{
...
struct NEO_DLL_DECL giant_eye_tentacleAI : public Scripted_NoMovementAI
{
