/* Copyright (C) 2006 - 2008 ScriptDev2 <https://scriptdev2.svn.sourceforge.net/>
    ...
    struct NEO_DLL_DECL boss_lady_blaumeuxAI : public ScriptedAI
    {
  ...
  //baron rivendare
   ...
   struct NEO_DLL_DECL boss_thane_korthazzAI : public ScriptedAI
   {
   ...
   struct NEO_DLL_DECL boss_sir_zeliekAI : public ScriptedAI
   {
