/* Copyright (C) 2009 NEO <http://www.neocore.info/>
...
//AI for Kalecgos
struct NEO_DLL_DECL boss_kalecgos_kjAI : public ScriptedAI
{
    ...
    void FindOrbs()
    {
        ...
        AllOrbsInGrid check;
        Neo::GameObjectListSearcher<AllOrbsInGrid> searcher(orbList, check);
        TypeContainerVisitor<Neo::GameObjectListSearcher<AllOrbsInGrid>, GridTypeMapContainer> visitor(searcher);
...
//AI for Kil'jaeden
struct NEO_DLL_DECL boss_kiljaedenAI : public Scripted_NoMovementAI
{
...
struct NEO_DLL_DECL mob_kiljaeden_controllerAI : public Scripted_NoMovementAI
{
...
struct NEO_DLL_DECL mob_hand_of_the_deceiverAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_felfire_portalAI : public Scripted_NoMovementAI
{
...
struct NEO_DLL_DECL mob_volatile_felfire_fiendAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_armageddonAI : public Scripted_NoMovementAI
{
...
//AI for Shield Orbs
struct NEO_DLL_DECL mob_shield_orbAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_sinster_reflectionAI : public ScriptedAI
{
