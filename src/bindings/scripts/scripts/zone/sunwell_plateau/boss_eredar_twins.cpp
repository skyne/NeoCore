...
struct NEO_DLL_DECL boss_sacrolashAI : public ScriptedAI
{
...
struct NEO_DLL_DECL boss_alythessAI : public Scripted_NoMovementAI
{
...
struct NEO_DLL_DECL mob_shadow_imageAI : public ScriptedAI
{
