...
struct NEO_DLL_DECL boss_kalecgosAI : public ScriptedAI
{
...
struct NEO_DLL_DECL boss_sathrovarrAI : public ScriptedAI
{
...
struct NEO_DLL_DECL boss_kalecAI : public ScriptedAI
{
    ScriptedInstance *pInstance;
