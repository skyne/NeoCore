...
struct NEO_DLL_DECL boss_felmystAI : public ScriptedAI
{
    ...
    void DespawnSummons(uint32 entry)
    {
...

        {
            ...
            Neo::AllCreaturesOfEntryInRange check(m_creature, entry, 100);
...
struct NEO_DLL_DECL mob_felmyst_vaporAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_felmyst_trailAI : public ScriptedAI
{
