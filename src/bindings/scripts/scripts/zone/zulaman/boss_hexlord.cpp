...
struct NEO_DLL_DECL boss_hexlord_addAI : public ScriptedAI
{
...
struct NEO_DLL_DECL boss_hex_lord_malacrassAI : public ScriptedAI
{
...
struct NEO_DLL_DECL boss_thurgAI : public boss_hexlord_addAI
{
...
struct NEO_DLL_DECL boss_alyson_antilleAI : public boss_hexlord_addAI
{
    //Holy Priest
...
struct NEO_DLL_DECL boss_gazakrothAI : public boss_hexlord_addAI
{
...
struct NEO_DLL_DECL boss_lord_raadanAI : public boss_hexlord_addAI
{
...
struct NEO_DLL_DECL boss_darkheartAI : public boss_hexlord_addAI
{
...
struct NEO_DLL_DECL boss_slitherAI : public boss_hexlord_addAI
{
...
struct NEO_DLL_DECL boss_fenstalkerAI : public boss_hexlord_addAI
{
...
struct NEO_DLL_DECL boss_koraggAI : public boss_hexlord_addAI
{
