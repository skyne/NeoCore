...
struct NEO_DLL_DECL boss_janalaiAI : public ScriptedAI
{
...
//        DoZoneInCombat();
    ...
    bool HatchAllEggs(uint32 action) //1: reset, 2: isHatching all
    {
...

        {
            ...
            Neo::AllCreaturesOfEntryInRange check(m_creature, MOB_EGG, 100);
            Neo::CreatureListSearcher<Neo::AllCreaturesOfEntryInRange> searcher(templist, check);

            TypeContainerVisitor<Neo::CreatureListSearcher<Neo::AllCreaturesOfEntryInRange>, GridTypeMapContainer> cSearcher(searcher);
    ...
    void Boom()
    {
...

        {
            ...
            Neo::AllCreaturesOfEntryInRange check(m_creature, MOB_FIRE_BOMB, 100);
            Neo::CreatureListSearcher<Neo::AllCreaturesOfEntryInRange> searcher(templist, check);
...
struct NEO_DLL_DECL mob_janalai_firebombAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_amanishi_hatcherAI : public ScriptedAI
{
    ...
    bool HatchEggs(uint32 num)
    {
...

        {
            ...
            Neo::AllCreaturesOfEntryInRange check(m_creature, 23817, 50);
            Neo::CreatureListSearcher<Neo::AllCreaturesOfEntryInRange> searcher(templist, check);
...
struct NEO_DLL_DECL mob_hatchlingAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_eggAI : public ScriptedAI
{
