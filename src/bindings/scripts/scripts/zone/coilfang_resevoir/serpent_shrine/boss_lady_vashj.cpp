...
//Lady Vashj AI
struct NEO_DLL_DECL boss_lady_vashjAI : public ScriptedAI
{
...
class NEO_DLL_DECL VashjSurgeAura : public Aura
{
    public:
...
struct NEO_DLL_DECL mob_enchanted_elementalAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_tainted_elementalAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_toxic_sporebatAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_coilfang_striderAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_shield_generator_channelAI : public ScriptedAI
{
