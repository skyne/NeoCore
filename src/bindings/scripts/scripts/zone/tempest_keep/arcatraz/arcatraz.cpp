...
struct NEO_DLL_DECL npc_millhouse_manastormAI : public ScriptedAI
{
...
struct NEO_DLL_DECL npc_warden_mellicharAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_zerekethvoidzoneAI : public ScriptedAI
{
