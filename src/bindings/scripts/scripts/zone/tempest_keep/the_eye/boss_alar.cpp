...
struct NEO_DLL_DECL boss_alarAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_ember_of_alarAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_flame_patch_alarAI : public ScriptedAI
{
