...
struct NEO_DLL_DECL npc_taskmaster_fizzuleAI : public ScriptedAI
{
    ...
    //supposed to happen (Neo not implemented/not found way to detect this spell kind)
    void DoUglyHack()
    {
...
struct NEO_DLL_DECL npc_twiggy_flatheadAI : public ScriptedAI
{
...
struct NEO_DLL_DECL npc_wizzlecrank_shredderAI : public npc_escortAI
{
