...
class NEO_DLL_DECL BurningNovaAura : public Aura
{
    public:
        BurningNovaAura(SpellEntry *spell, uint32 eff, Unit *target, Unit *caster) : Aura(spell, eff, NULL, target, caster, NULL){}
};

struct NEO_DLL_DECL boss_kelidan_the_breakerAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_shadowmoon_channelerAI : public ScriptedAI
{
