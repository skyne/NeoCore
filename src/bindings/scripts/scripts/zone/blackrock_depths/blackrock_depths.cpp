...
struct NEO_DLL_DECL npc_grimstoneAI : public npc_escortAI
{
...
struct NEO_DLL_DECL mob_phalanxAI : public ScriptedAI
{
...
ScriptedInstance *pInstance;
/*
struct NEO_DLL_DECL npc_dughal_stormwingAI : public npc_escortAI
{
...
Player* PlayerStart;
/*
struct NEO_DLL_DECL npc_marshal_windsorAI : public npc_escortAI
{
...
int wp = 0;
/*
struct NEO_DLL_DECL npc_marshal_reginald_windsorAI : public npc_escortAI
{
...
/*
struct NEO_DLL_DECL npc_tobias_seecherAI : public npc_escortAI
{
...
struct NEO_DLL_DECL npc_rocknotAI : public npc_escortAI
{
