...
######*/
/*
struct NEO_DLL_DECL mobs_mana_tappedAI : public ScriptedAI
{
...
struct NEO_DLL_DECL npc_prospector_anvilwardAI : public npc_escortAI
{
...
struct NEO_DLL_DECL npc_secondTrialAI : public ScriptedAI
{
...
struct NEO_DLL_DECL master_kelerun_bloodmournAI : public ScriptedAI
{
...
bool GOHello_go_second_trial(Player *player, GameObject* _GO)
{
    ...
    CellPair p(Neo::ComputeCellPair(_GO->GetPositionX(), _GO->GetPositionY()));
    Cell cell(p);
    ...
    Neo::NearestCreatureEntryWithLiveStateInObjectRangeCheck u_check(*_GO, MASTER_KELERUN_BLOODMOURN, true, 30);
    Neo::CreatureLastSearcher<Neo::NearestCreatureEntryWithLiveStateInObjectRangeCheck> searcher(event_controller, u_check);
    TypeContainerVisitor<Neo::CreatureLastSearcher<Neo::NearestCreatureEntryWithLiveStateInObjectRangeCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
struct NEO_DLL_DECL npc_apprentice_mirvedaAI : public ScriptedAI
{
...
struct NEO_DLL_DECL npc_infused_crystalAI : public Scripted_NoMovementAI
{
