...
struct NEO_DLL_DECL boss_nexusprince_shaffarAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_ethereal_beaconAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_ethereal_apprenticeAI : public ScriptedAI
{
