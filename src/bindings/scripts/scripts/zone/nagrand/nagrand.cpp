...
struct NEO_DLL_DECL mob_shattered_rumblerAI : public ScriptedAI
{
    bool Spawn;
...
struct NEO_DLL_DECL mob_lumpAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_sunspring_villagerAI : public ScriptedAI
{
...
struct NEO_DLL_DECL npc_creditmarker_visit_with_ancestorsAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_sparrowhawkAI : public ScriptedAI
{
