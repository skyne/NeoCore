...
struct NEO_DLL_DECL mobs_bladespire_ogreAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mobs_nether_drakeAI : public ScriptedAI
{
...
struct NEO_DLL_DECL npc_daranelleAI : public ScriptedAI
{
