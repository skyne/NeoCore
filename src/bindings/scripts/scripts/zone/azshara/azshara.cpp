...
struct NEO_DLL_DECL mobs_spitelashesAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_rizzle_sprysprocketAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_depth_chargeAI : public ScriptedAI
{
