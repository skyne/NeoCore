...
struct NEO_DLL_DECL npc_raliq_the_drunkAI : public ScriptedAI
{
...
struct NEO_DLL_DECL npc_salsalabimAI : public ScriptedAI
{
...
struct NEO_DLL_DECL npc_kservantAI : public npc_escortAI
{
public:
...
struct NEO_DLL_DECL npc_dirty_larryAI : public ScriptedAI
{
