...
struct NEO_DLL_DECL mob_doom_blossomAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_shadowy_constructAI : public ScriptedAI
{
...
struct NEO_DLL_DECL boss_teron_gorefiendAI : public ScriptedAI
{
    ...
    void MindControlGhost()
    {
        ...
        /**  ONLY AFTER Neo FULLY IMPLEMENTS MIND CONTROL ABILITIES      *****/
