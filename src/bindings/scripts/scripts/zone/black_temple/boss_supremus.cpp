...
struct NEO_DLL_DECL molten_flameAI : public NullCreatureAI
{
...
struct NEO_DLL_DECL boss_supremusAI : public ScriptedAI
{
...
struct NEO_DLL_DECL npc_volcanoAI : public ScriptedAI
{
