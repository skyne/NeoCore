...
struct NEO_DLL_DECL mob_ashtongue_channelerAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_ashtongue_sorcererAI : public ScriptedAI
{
...
struct NEO_DLL_DECL boss_shade_of_akamaAI : public ScriptedAI
{
    ...
    void FindChannelers()
    {
        ...
        Neo::AllCreaturesOfEntryInRange check(m_creature, CREATURE_CHANNELER, 50);
        Neo::CreatureListSearcher<Neo::AllCreaturesOfEntryInRange> searcher(ChannelerList, check);
...
struct NEO_DLL_DECL npc_akamaAI : public ScriptedAI
{
