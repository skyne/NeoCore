...
/************************************** Illidan's AI ***************************************/
struct NEO_DLL_DECL boss_illidan_stormrageAI : public ScriptedAI
{
...
struct NEO_DLL_DECL flame_of_azzinothAI : public ScriptedAI
{
...
struct NEO_DLL_DECL npc_akama_illidanAI : public ScriptedAI
{
...
struct NEO_DLL_DECL boss_maievAI : public ScriptedAI
{
...
struct NEO_DLL_DECL cage_trap_triggerAI : public ScriptedAI
{
...
bool GOHello_cage_trap(Player* plr, GameObject* go)
{
    ...
    Neo::NearestCreatureEntryWithLiveStateInObjectRangeCheck check(*plr, 23304, true, 10);
    Neo::CreatureLastSearcher<Neo::NearestCreatureEntryWithLiveStateInObjectRangeCheck> searcher(trigger, check);

    TypeContainerVisitor<Neo::CreatureLastSearcher<Neo::NearestCreatureEntryWithLiveStateInObjectRangeCheck>, GridTypeMapContainer> cSearcher(searcher);
...
struct NEO_DLL_DECL shadow_demonAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_parasitic_shadowfiendAI : public ScriptedAI
{
...
struct NEO_DLL_DECL blade_of_azzinothAI : public NullCreatureAI
{
