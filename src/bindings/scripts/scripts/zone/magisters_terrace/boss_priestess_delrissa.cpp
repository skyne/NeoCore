...
struct NEO_DLL_DECL boss_priestess_delrissaAI : public ScriptedAI
{
...
struct NEO_DLL_DECL boss_priestess_guestAI : public ScriptedAI
{
...
struct NEO_DLL_DECL boss_kagani_nightstrikeAI : public boss_priestess_guestAI
{
    //Rogue
...
/*struct NEO_DLL_DECL mob_fizzleAI : public ScriptedAI
{
...
struct NEO_DLL_DECL boss_ellris_duskhallowAI : public boss_priestess_guestAI
{
    //Warlock
...
struct NEO_DLL_DECL boss_eramas_brightblazeAI : public boss_priestess_guestAI
{
    //Monk
...
struct NEO_DLL_DECL boss_yazzaiAI : public boss_priestess_guestAI
{
    //Mage
...
struct NEO_DLL_DECL boss_warlord_salarisAI : public boss_priestess_guestAI
{
    //Warrior
...
/*struct NEO_DLL_DECL mob_sliverAI : public ScriptedAI
{
...
struct NEO_DLL_DECL boss_garaxxasAI : public boss_priestess_guestAI
{
    //Hunter
...
struct NEO_DLL_DECL boss_apokoAI : public boss_priestess_guestAI
{
    //Shaman
...
struct NEO_DLL_DECL boss_zelfanAI : public boss_priestess_guestAI
{
    //Engineer
...
//struct NEO_DLL_DECL mob_high_explosive_sheepAI : public ScriptedAI
//{
