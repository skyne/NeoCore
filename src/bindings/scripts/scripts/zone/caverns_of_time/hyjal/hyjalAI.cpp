...
void hyjalAI::HideNearPos(float x, float y)
{
    ...
    Neo::AllFriendlyCreaturesInGrid creature_check(m_creature);
    Neo::CreatureListSearcher<Neo::AllFriendlyCreaturesInGrid> creature_searcher(creatures, creature_check);
