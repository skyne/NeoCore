...
struct NEO_DLL_DECL mob_doomfireAI : public ScriptedAI
{
...
struct NEO_DLL_DECL mob_doomfire_targettingAI : public ScriptedAI
{
...
struct NEO_DLL_DECL boss_archimondeAI : public hyjal_trashAI
{
