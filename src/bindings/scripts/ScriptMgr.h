...
#define DEFAULT_TEXT        "<Neo Script Text Entry Missing!>"
...
#ifdef WIN32
  #define NEO_DLL_EXPORT extern "C" __declspec(dllexport)
#elif defined( __GNUC__ )
#define NEO_DLL_EXPORT extern "C"
#else
#define NEO_DLL_EXPORT extern "C" export
#endif
