...
#ifndef NEO_CREATIONPOLICY_H
#define NEO_CREATIONPOLICY_H
...
namespace Neo
{
     ...
     */
    template <class T>
        class NEO_DLL_DECL OperatorNew
    {
        public:
     ...
     */
    template <class T>
        class NEO_DLL_DECL LocalStaticCreation
    {
        union MaxAlign
        {
            char t_[sizeof(T)];
     ...
     */
    template<class T>
        class NEO_DLL_DECL CreateUsingMalloc
    {
        public:
            static T* Create()
            {
    ...
    template<class T, class CALL_BACK>
        class NEO_DLL_DECL CreateOnCallBack
    {
        public:
            static T* Create()
            {
