...
#ifndef NEO_THREADINGMODEL_H
#define NEO_THREADINGMODEL_H
...
namespace Neo
{
    ...
    template<typename MUTEX> class NEO_DLL_DECL GeneralLock
    {
        public:
    ...
    template <class T>
        class NEO_DLL_DECL SingleThreaded
    {
        public:
    ...
    template<class T, class MUTEX>
        class NEO_DLL_DECL ObjectLevelLockable
    {
        public:
    ...
    template<class T, class MUTEX>
        class NEO_DLL_DECL ClassLevelLockable
    {
        public:
            class Lock;
            friend class Lock;
...
template<class T, class MUTEX> MUTEX Neo::ClassLevelLockable<T, MUTEX>::si_mtx;

#define INSTANTIATE_CLASS_MUTEX(CTYPE,MUTEX) \
    template class NEO_DLL_DECL Neo::ClassLevelLockable<CTYPE, MUTEX >
#endif
