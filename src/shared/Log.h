...
#ifndef NEOCORE_LOG_H
#define NEOCORE_LOG_H
...
class Log : public Neo::Singleton<Log, Neo::ClassLevelLockable<Log, ACE_Thread_Mutex> >
{
    friend class Neo::OperatorNew<Log>;
    Log();
    ~Log();
...
#define sLog Neo::Singleton<Log>::Instance()

#ifdef NEO_DEBUG
#define DEBUG_LOG Neo::Singleton<Log>::Instance().outDebug
#else
#define DEBUG_LOG
#endif

// primary for script library
void NEO_DLL_SPEC outstring_log(const char * str, ...) ATTR_PRINTF(1,2);
void NEO_DLL_SPEC detail_log(const char * str, ...) ATTR_PRINTF(1,2);
void NEO_DLL_SPEC debug_log(const char * str, ...) ATTR_PRINTF(1,2);
void NEO_DLL_SPEC error_log(const char * str, ...) ATTR_PRINTF(1,2);
void NEO_DLL_SPEC error_db_log(const char * str, ...) ATTR_PRINTF(1,2);
#endif
