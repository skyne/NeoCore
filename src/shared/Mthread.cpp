...
#  define NEO_PTHREAD_MUTEX_RECURSIVE PTHREAD_MUTEX_RECURSIVE
#else
#  define NEO_PTHREAD_MUTEX_RECURSIVE PTHREAD_MUTEX_RECURSIVE_NP
#endif
...
MMutex::MMutex ()
{
    if (!attr_refcount++)
    {
        ...
        pthread_mutexattr_settype (&attr, NEO_PTHREAD_MUTEX_RECURSIVE);
    }
