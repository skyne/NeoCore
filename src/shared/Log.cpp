...
FILE* Log::openGmlogPerAccount(uint32 account)
{
    ...
    char namebuf[NEO_PATH_MAX];
    snprintf(namebuf,NEO_PATH_MAX,m_gmlog_filename_format.c_str(),account);
...
void outstring_log(const char * str, ...)
{
    ...
    Neo::Singleton<Log>::Instance().outString(buf);
}
...
void detail_log(const char * str, ...)
{
    ...
    Neo::Singleton<Log>::Instance().outDetail(buf);
}
...
void debug_log(const char * str, ...)
{
    ...
    Neo::Singleton<Log>::Instance().outDebug(buf);
}
...
void error_log(const char * str, ...)
{
    ...
    Neo::Singleton<Log>::Instance().outError(buf);
}
...
void error_db_log(const char * str, ...)
{
    ...
    Neo::Singleton<Log>::Instance().outErrorDb(buf);
}
