...
class SqlResultQueue : public ACE_Based::LockedQueue<Neo::IQueryCallback* , ACE_Thread_Mutex>
{
    public:
        SqlResultQueue() {}
        void Update();
...
class SqlQuery : public SqlOperation
{
    private:
        const char *m_sql;
        Neo::IQueryCallback * m_callback;
        SqlResultQueue * m_queue;
    public:
        SqlQuery(const char *sql, Neo::IQueryCallback * callback, SqlResultQueue * queue)
...
class SqlQueryHolder
{
    ...
    public:
        ...
        bool Execute(Neo::IQueryCallback * callback, SqlDelayThread *thread, SqlResultQueue *queue);
};
...
class SqlQueryHolderEx : public SqlOperation
{
    private:
        ...
        SqlResultQueue * m_queue;
    public:
        SqlQueryHolderEx(SqlQueryHolder *holder, Neo::IQueryCallback * callback, SqlResultQueue * queue)
