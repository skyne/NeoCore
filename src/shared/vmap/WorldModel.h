...
#include "../../../dep/include/g3dlite/G3D/Vector3.h"
#include "../../../dep/include/g3dlite/G3D/AABox.h"
#include "../../../dep/include/g3dlite/G3D/Ray.h"
#include "BIH.h"
...
namespace VMAP
{
    ...
    class WorldModel
    {
        public:
			...
			float GetHeight(uint32 entry) const;
            bool IntersectRay(const G3D::Ray &ray, float &distance, bool stopAtFirstHit) const;
