...
{
    CellPair p(Neo::ComputeCellPair(me->GetPositionX(), me->GetPositionY()));
    Cell cell(p);
    ...
    Neo::MostHPMissingInRange u_check(me, range, MinHPDiff);
    Neo::UnitLastSearcher<Neo::MostHPMissingInRange> searcher(me, pUnit, u_check);
...
void CreatureEventAI::DoFindFriendlyCC(std::list<Creature*>& _list, float range)
{
    ...
    Neo::FriendlyCCedInRange u_check(me, range);
    Neo::CreatureListSearcher<Neo::FriendlyCCedInRange> searcher(me, _list, u_check);
...
void CreatureEventAI::DoFindFriendlyMissingBuff(std::list<Creature*>& _list, float range, uint32 spellid)
{
    ...
    Neo::FriendlyMissingBuffInRange u_check(me, range, spellid);
    Neo::CreatureListSearcher<Neo::FriendlyMissingBuffInRange> searcher(me, _list, u_check);
