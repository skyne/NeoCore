...
TotemAI::UpdateAI(const uint32 /*diff*/)
{
  if (me->ToTotem()->GetTotemType() != TOTEM_ACTIVE)
    ...
    {
        victim = NULL;
        Neo::NearestAttackableUnitInObjectRangeCheck u_check(me, me, max_range);
        Neo::UnitLastSearcher<Neo::NearestAttackableUnitInObjectRangeCheck> checker(me, victim, u_check);
