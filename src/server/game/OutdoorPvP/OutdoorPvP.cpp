...
bool OPvPCapturePoint::Update(uint32 diff)
{
    ...
    Neo::AnyPlayerInObjectRangeCheck checker(m_capturePoint, radius);
    Neo::PlayerListSearcher<Neo::AnyPlayerInObjectRangeCheck> searcher(m_capturePoint, players, checker);
