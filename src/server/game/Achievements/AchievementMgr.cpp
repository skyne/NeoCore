...
void AchievementMgr::SendAchievementEarned(AchievementEntry const* achievement)
{
    ...
    {
        Neo::AchievementChatBuilder say_builder(*GetPlayer(), CHAT_MSG_GUILD_ACHIEVEMENT, LANG_ACHIEVEMENT_EARNED,achievement->ID);
        Neo::LocalizedPacketDo<Neo::AchievementChatBuilder> say_do(say_builder);
    ...
    else if (GetPlayer()->IsInWorld())
    {
        ...
        Neo::AchievementChatBuilder say_builder(*GetPlayer(), CHAT_MSG_ACHIEVEMENT, LANG_ACHIEVEMENT_EARNED,achievement->ID);
        Neo::LocalizedPacketDo<Neo::AchievementChatBuilder> say_do(say_builder);
        Neo::PlayerDistWorker<Neo::LocalizedPacketDo<Neo::AchievementChatBuilder> > say_worker(GetPlayer(),sWorld.getFloatConfig(CONFIG_LISTEN_RANGE_SAY),say_do);
        TypeContainerVisitor<Neo::PlayerDistWorker<Neo::LocalizedPacketDo<Neo::AchievementChatBuilder> >, WorldTypeMapContainer > message(say_worker);
