...
GameObject* ChatHandler::GetNearbyGameObject()
{
    ...
    GameObject* obj = NULL;
    Neo::NearestGameObjectCheck check(*pl);
    Neo::GameObjectLastSearcher<Neo::NearestGameObjectCheck> searcher(pl, obj, check);
...
GameObject* ChatHandler::GetObjectGlobalyWithGuidOrNearWithDbGuid(uint32 lowguid,uint32 entry)
{
    ...
    if (!obj && sObjectMgr.GetGOData(lowguid))                   // guid is DB guid of object
    {
        ...
        Neo::GameObjectSearcher<Neo::GameObjectWithDbGUIDCheck> checker(pl,obj,go_check);
