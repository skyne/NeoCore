...
bool ChatHandler::HandleDebugEnterVehicle(const char * args)
{
    ...
    else
    {
        ...
        Neo::AllCreaturesOfEntryInRange check(m_session->GetPlayer(), entry, 20.0f);
        Neo::CreatureSearcher<Neo::AllCreaturesOfEntryInRange> searcher(m_session->GetPlayer(), passenger, check);
