        ...
        case GO_READY:
        {
            ...
            if (isSpawned())
            {
                ...
                if (goInfo->type == GAMEOBJECT_TYPE_TRAP)
                {
                    ...
                    {
                        Neo::AnyUnfriendlyNoTotemUnitInObjectRangeCheck checker(this, owner, radius);
                        Neo::UnitSearcher<Neo::AnyUnfriendlyNoTotemUnitInObjectRangeCheck> searcher(this, ok, checker);
                    ...
                    else                                        // environmental trap
                    {
                        ...
                        // affect only players
                        Player* player = NULL;
                        Neo::AnyPlayerInObjectRangeCheck checker(this, radius);
                        Neo::PlayerSearcher<Neo::AnyPlayerInObjectRangeCheck> searcher(this, player, checker);
...
void GameObject::TriggeringLinkedGameObject(uint32 trapEntry, Unit* target)
{
    ...
    GameObject* trapGO = NULL;
    {
        ...
        Neo::GameObjectLastSearcher<Neo::NearestGameObjectEntryInObjectRangeCheck> checker(this, trapGO,go_check);
...
GameObject* GameObject::LookupFishingHoleAround(float range)
{
    ...
    Neo::GameObjectSearcher<Neo::NearestGameObjectFishingHole> checker(this, ok, u_check);
