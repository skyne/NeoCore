...
void Creature::DoFleeToGetAssistance()
{
    ...
    if (radius >0)
    {
        ...
        cell.SetNoCreate();
        Neo::NearestAssistCreatureInCreatureRangeCheck u_check(this, getVictim(), radius);
        Neo::CreatureLastSearcher<Neo::NearestAssistCreatureInCreatureRangeCheck> searcher(this, pCreature, u_check);

        TypeContainerVisitor<Neo::CreatureLastSearcher<Neo::NearestAssistCreatureInCreatureRangeCheck>, GridTypeMapContainer > grid_creature_searcher(searcher);
...
Unit* Creature::SelectNearestTarget(float dist) const
{
...

    {
        ...
        Neo::NearestHostileUnitCheck u_check(this, dist);
        Neo::UnitLastSearcher<Neo::NearestHostileUnitCheck> searcher(this, target, u_check);

        TypeContainerVisitor<Neo::UnitLastSearcher<Neo::NearestHostileUnitCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<Neo::UnitLastSearcher<Neo::NearestHostileUnitCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Unit* Creature::SelectNearestTargetInAttackDistance(float dist) const
{
    ...
    {
        Neo::NearestHostileUnitInAttackDistanceCheck u_check(this, dist);
        Neo::UnitLastSearcher<Neo::NearestHostileUnitInAttackDistanceCheck> searcher(this, target, u_check);

        TypeContainerVisitor<Neo::UnitLastSearcher<Neo::NearestHostileUnitInAttackDistanceCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<Neo::UnitLastSearcher<Neo::NearestHostileUnitInAttackDistanceCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
    ...
    if (!m_AlreadyCallAssistance && getVictim() && !isPet() && !isCharmed())
    {
        ...
        if (radius > 0)
        {
...

            {
                ...
                Neo::AnyAssistCreatureInRangeCheck u_check(this, getVictim(), radius);
                Neo::CreatureListSearcher<Neo::AnyAssistCreatureInRangeCheck> searcher(this, assistList, u_check);

                TypeContainerVisitor<Neo::CreatureListSearcher<Neo::AnyAssistCreatureInRangeCheck>, GridTypeMapContainer >  grid_creature_searcher(searcher);
...
void Creature::CallForHelp(float fRadius)
{
    ...
    Neo::CallOfHelpCreatureInRangeDo u_do(this, getVictim(), fRadius);
    Neo::CreatureWorker<Neo::CallOfHelpCreatureInRangeDo> worker(this, u_do);

    TypeContainerVisitor<Neo::CreatureWorker<Neo::CallOfHelpCreatureInRangeDo>, GridTypeMapContainer >  grid_creature_searcher(worker);
