...
namespace Neo
{
    class MonsterChatBuilder
    {
        public:
            ...
            {
                char const* text = sObjectMgr.GetNeoString(i_textId,loc_idx);
...
void WorldObject::MonsterSay(int32 textId, uint32 language, uint64 TargetGuid)
{
    ...
    Neo::MonsterChatBuilder say_build(*this, CHAT_MSG_MONSTER_SAY, textId,language,TargetGuid);
    Neo::LocalizedPacketDo<Neo::MonsterChatBuilder> say_do(say_build);
    Neo::PlayerDistWorker<Neo::LocalizedPacketDo<Neo::MonsterChatBuilder> > say_worker(this,sWorld.getFloatConfig(CONFIG_LISTEN_RANGE_SAY),say_do);
    TypeContainerVisitor<Neo::PlayerDistWorker<Neo::LocalizedPacketDo<Neo::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterYell(int32 textId, uint32 language, uint64 TargetGuid)
{
    ...
    Neo::MonsterChatBuilder say_build(*this, CHAT_MSG_MONSTER_YELL, textId,language,TargetGuid);
    Neo::LocalizedPacketDo<Neo::MonsterChatBuilder> say_do(say_build);
    Neo::PlayerDistWorker<Neo::LocalizedPacketDo<Neo::MonsterChatBuilder> > say_worker(this,sWorld.getFloatConfig(CONFIG_LISTEN_RANGE_YELL),say_do);
    TypeContainerVisitor<Neo::PlayerDistWorker<Neo::LocalizedPacketDo<Neo::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterTextEmote(int32 textId, uint64 TargetGuid, bool IsBossEmote)
{
    ...
    Neo::MonsterChatBuilder say_build(*this, IsBossEmote ? CHAT_MSG_RAID_BOSS_EMOTE : CHAT_MSG_MONSTER_EMOTE, textId,LANG_UNIVERSAL,TargetGuid);
    Neo::LocalizedPacketDo<Neo::MonsterChatBuilder> say_do(say_build);
    Neo::PlayerDistWorker<Neo::LocalizedPacketDo<Neo::MonsterChatBuilder> > say_worker(this,sWorld.getFloatConfig(CONFIG_LISTEN_RANGE_TEXTEMOTE),say_do);
    TypeContainerVisitor<Neo::PlayerDistWorker<Neo::LocalizedPacketDo<Neo::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterWhisper(int32 textId, uint64 receiver, bool IsBossWhisper)
{
    ...
    char const* text = sObjectMgr.GetNeoString(textId, loc_idx);
...
Creature* WorldObject::FindNearestCreature(uint32 entry, float range, bool alive)
{
    ...
    Neo::NearestCreatureEntryWithLiveStateInObjectRangeCheck checker(*this, entry, alive, range);
    Neo::CreatureLastSearcher<Neo::NearestCreatureEntryWithLiveStateInObjectRangeCheck> searcher(this, creature, checker);
...
{
    GameObject *go = NULL;
    Neo::NearestGameObjectEntryInObjectRangeCheck checker(*this, entry, range);
    Neo::GameObjectLastSearcher<Neo::NearestGameObjectEntryInObjectRangeCheck> searcher(this, go, checker);
...
{
    CellPair pair(Neo::ComputeCellPair(this->GetPositionX(), this->GetPositionY()));
    Cell cell(pair);
    cell.data.Part.reserved = ALL_DISTRICT;
    cell.SetNoCreate();

    Neo::AllGameObjectsWithEntryInRange check(this, uiEntry, fMaxSearchRange);
    Neo::GameObjectListSearcher<Neo::AllGameObjectsWithEntryInRange> searcher(this, lList, check);
    TypeContainerVisitor<Neo::GameObjectListSearcher<Neo::AllGameObjectsWithEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
void WorldObject::GetCreatureListWithEntryInGrid(std::list<Creature*>& lList, uint32 uiEntry, float fMaxSearchRange)
{
    ...
    Neo::AllCreaturesOfEntryInRange check(this, uiEntry, fMaxSearchRange);
    Neo::CreatureListSearcher<Neo::AllCreaturesOfEntryInRange> searcher(this, lList, check);
    TypeContainerVisitor<Neo::CreatureListSearcher<Neo::AllCreaturesOfEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
void WorldObject::GetNearPoint(WorldObject const* /*searcher*/, float &x, float &y, float &z, float searcher_size, float distance2d, float absAngle) const
{
    ...
    // adding used positions around object
    {
        ...
        Neo::NearUsedPosDo u_do(*this,searcher,absAngle,selector);
        Neo::WorldObjectWorker<Neo::NearUsedPosDo> worker(this,u_do);

        TypeContainerVisitor<Neo::WorldObjectWorker<Neo::NearUsedPosDo>, GridTypeMapContainer  > grid_obj_worker(worker);
        TypeContainerVisitor<Neo::WorldObjectWorker<Neo::NearUsedPosDo>, WorldTypeMapContainer > world_obj_worker(worker);
...
void WorldObject::MovePosition(Position &pos, float dist, float angle)
{
    ...
    Neo::NormalizeMapCoord(pos.m_positionX);
    Neo::NormalizeMapCoord(pos.m_positionY);
...
void WorldObject::DestroyForNearbyPlayers()
{
    ...
    Neo::AnyPlayerInObjectRangeCheck check(this, GetMap()->GetVisibilityDistance());
    Neo::PlayerListSearcher<Neo::AnyPlayerInObjectRangeCheck> searcher(this, targets, check);
...
void WorldObject::UpdateObjectVisibility(bool /*forced*/)
{
    ...
    Neo::VisibleChangesNotifier notifier(*this);
    VisitNearbyWorldObject(GetMap()->GetVisibilityDistance(), notifier);
}
