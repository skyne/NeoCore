...
void hyjalAI::HideNearPos(float x, float y)
{
    ...
    Neo::AllFriendlyCreaturesInGrid creature_check(me);
    Neo::CreatureListSearcher<Neo::AllFriendlyCreaturesInGrid> creature_searcher(me, creatures, creature_check);
    TypeContainerVisitor
        <Neo::CreatureListSearcher<Neo::AllFriendlyCreaturesInGrid>,
...
void hyjalAI::RespawnNearPos(float x, float y)
{
    ...
    Neo::RespawnDo u_do;
    Neo::WorldObjectWorker<Neo::RespawnDo> worker(me, u_do);
