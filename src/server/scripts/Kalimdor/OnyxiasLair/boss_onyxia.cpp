            ...
            if (m_uiPhase == PHASE_START || m_uiPhase == PHASE_END)
            {
                ...
                else
                {
                    if (m_uiBellowingRoarTimer <= uiDiff)
                    {
                        ...
                        Neo::GameObjectInRangeCheck check(me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(), 15);
                        Neo::GameObjectLastSearcher<Neo::GameObjectInRangeCheck> searcher(me, pFloor, check);
