...
public:
    ...
    struct boss_sartharionAI : public ScriptedAI
    {
        ...
        void CastLavaStrikeOnTarget(Unit* target)
        {
            ...
            Neo::AllCreaturesOfEntryInRange checker(me, NPC_FIRE_CYCLONE, 200.0f);
            Neo::CreatureListSearcher<Neo::AllCreaturesOfEntryInRange> searcher(me, pFireCyclonesList, checker);
