/*
 * Copyright (C) 2008-2010 NeoCore <http://www.neocore.org/>
        ...
        struct boss_akilzonAI : public ScriptedAI
        {
            ...
            void HandleStormSequence(Unit *Cloud) // 1: begin, 2-9: tick, 10: end
            {
                if (StormCount < 10 && StormCount > 1)
                {
                    ...
                    {
                        Neo::AnyAoETargetUnitInObjectRangeCheck u_check(me, me, 999);
                        Neo::UnitListSearcher<Neo::AnyAoETargetUnitInObjectRangeCheck> searcher(me, tempUnitMap, u_check);
