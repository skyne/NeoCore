        ...
        //        DoZoneInCombat();
            ...
            bool HatchAllEggs(uint32 uiAction) //1: reset, 2: isHatching all
            {
...

                {
                    ...
                    Neo::AllCreaturesOfEntryInRange check(me, MOB_EGG, 100);
                    Neo::CreatureListSearcher<Neo::AllCreaturesOfEntryInRange> searcher(me, templist, check);
            ...
            void Boom()
            {
...

                {
                    ...
                    Neo::AllCreaturesOfEntryInRange check(me, MOB_FIRE_BOMB, 100);
                    Neo::CreatureListSearcher<Neo::AllCreaturesOfEntryInRange> searcher(me, templist, check);
        ...
        struct mob_janalai_hatcherAI : public ScriptedAI
        {
            ...
            bool HatchEggs(uint32 num)
            {
...

                {
                    ...
                    Neo::AllCreaturesOfEntryInRange check(me, 23817, 50);
                    Neo::CreatureListSearcher<Neo::AllCreaturesOfEntryInRange> searcher(me, templist, check);
