...
#ifndef NEO_IDLEMOVEMENTGENERATOR_H
#define NEO_IDLEMOVEMENTGENERATOR_H

#include "MovementGenerator.h"

class NEO_DLL_SPEC IdleMovementGenerator : public MovementGenerator
{
    public:
...
class NEO_DLL_SPEC RotateMovementGenerator : public MovementGenerator
{
    public:
...
class NEO_DLL_SPEC DistractMovementGenerator : public MovementGenerator
{
    public:
...
class NEO_DLL_SPEC AssistanceDistractMovementGenerator : public DistractMovementGenerator
{
    public:
