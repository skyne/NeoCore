...
#ifndef NEO_FLEEINGMOVEMENTGENERATOR_H
#define NEO_FLEEINGMOVEMENTGENERATOR_H
...
template<class T>
class NEO_DLL_SPEC FleeingMovementGenerator
...
class NEO_DLL_SPEC TimedFleeingMovementGenerator
