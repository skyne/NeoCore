...
#ifndef NEO_GRIDNOTIFIERS_H
#define NEO_GRIDNOTIFIERS_H
...
namespace Neo
{
    struct NEO_DLL_DECL PlayerVisibilityNotifier
    {
        Player &i_player;
        UpdateData i_data;
    ...
    struct NEO_DLL_DECL PlayerRelocationNotifier : public PlayerVisibilityNotifier
    {
    ...
    struct NEO_DLL_DECL CreatureRelocationNotifier
    {
        Creature &i_creature;
    ...
    struct NEO_DLL_DECL VisibleChangesNotifier
    {
    ...
    struct NEO_DLL_DECL GridUpdater
    {
        GridType &i_grid;
        uint32 i_timeDiff;
    ...
    struct NEO_DLL_DECL MessageDeliverer : public Deliverer
    {
    ...
    struct NEO_DLL_DECL ObjectMessageDeliverer : public Deliverer
    {
    ...
    struct NEO_DLL_DECL MessageDistDeliverer : public Deliverer
    {
        bool i_ownTeamOnly;
    ...
    struct NEO_DLL_DECL ObjectMessageDistDeliverer : public Deliverer
    {
    ...
    struct NEO_DLL_DECL ObjectUpdater
    {
        uint32 i_timeDiff;
    ...
    template<class T>
        struct NEO_DLL_DECL ObjectAccessorNotifier
    {
        T *& i_object;
    ...
    struct NEO_DLL_DECL DynamicObjectUpdater
    {
    ...
    template<class Check>
        struct NEO_DLL_DECL WorldObjectSearcher
    {
        WorldObject* &i_object;
        Check &i_check;
    ...
    template<class Check>
        struct NEO_DLL_DECL WorldObjectListSearcher
    {
    ...
    template<class Do>
        struct NEO_DLL_DECL WorldObjectWorker
    {
        Do const& i_do;
    ...
    template<class Check>
        struct NEO_DLL_DECL GameObjectSearcher
    {
        GameObject* &i_object;
        Check &i_check;
    ...
    template<class Check>
        struct NEO_DLL_DECL GameObjectLastSearcher
    {
        GameObject* &i_object;
        Check& i_check;
    ...
    template<class Check>
        struct NEO_DLL_DECL GameObjectListSearcher
    {
    ...
    template<class Check>
        struct NEO_DLL_DECL UnitSearcher
    {
        Unit* &i_object;
        Check & i_check;
    ...
    template<class Check>
        struct NEO_DLL_DECL UnitLastSearcher
    {
        Unit* &i_object;
        Check & i_check;
    ...
    template<class Check>
        struct NEO_DLL_DECL UnitListSearcher
    {
    ...
    template<class Check>
        struct NEO_DLL_DECL CreatureSearcher
    {
        Creature* &i_object;
        Check & i_check;
    ...
    template<class Check>
        struct NEO_DLL_DECL CreatureLastSearcher
    {
        Creature* &i_object;
        Check & i_check;
    ...
    template<class Check>
    struct NEO_DLL_DECL CreatureListSearcher
    {
    ...
    template<class Do>
    struct NEO_DLL_DECL CreatureWorker
    {
        Do& i_do;
    ...
    template<class Check>
    struct NEO_DLL_DECL PlayerSearcher
    {
        Player* &i_object;
        Check & i_check;
    ...
    template<class Do>
    struct NEO_DLL_DECL PlayerWorker
    {
        Do& i_do;
