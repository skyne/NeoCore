...
#ifndef NEO_WAYPOINTMOVEMENTGENERATOR_H
#define NEO_WAYPOINTMOVEMENTGENERATOR_H
...
class NEO_DLL_SPEC PathMovementBase
{
    public:
...
class NEO_DLL_SPEC WaypointMovementGenerator
 ...
 */
class NEO_DLL_SPEC FlightPathMovementGenerator
