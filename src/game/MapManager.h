...
#ifndef NEO_MAPMANAGER_H
#define NEO_MAPMANAGER_H
...
class NEO_DLL_DECL MapManager : public Neo::Singleton<MapManager, Neo::ClassLevelLockable<MapManager, ACE_Thread_Mutex> >
{

    friend class Neo::OperatorNew<MapManager>;
    ...
    public:
        ...
        {
            return IsValidMAP(mapid) && Neo::IsValidMapCoord(x,y);
        }

        static bool IsValidMapCoord(uint32 mapid, float x,float y,float z)
        {
            return IsValidMAP(mapid) && Neo::IsValidMapCoord(x,y,z);
        }

        static bool IsValidMapCoord(uint32 mapid, float x,float y,float z,float o)
        {
            return IsValidMAP(mapid) && Neo::IsValidMapCoord(x,y,z,o);
        }
    ...
    private:
        ...
        typedef Neo::ClassLevelLockable<MapManager, ACE_Thread_Mutex>::Lock Guard;
