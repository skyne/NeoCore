...
#ifndef NEO_POINTMOVEMENTGENERATOR_H
#define NEO_POINTMOVEMENTGENERATOR_H
...
template<class T>
class NEO_DLL_SPEC PointMovementGenerator
...
class NEO_DLL_SPEC AssistanceMovementGenerator
