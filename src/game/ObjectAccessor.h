...
#ifndef NEO_OBJECTACCESSOR_H
#define NEO_OBJECTACCESSOR_H
...
class HashMapHolder
{
    public:
        ...
        typedef Neo::GeneralLock<LockType > Guard;
...
class NEO_DLL_DECL ObjectAccessor : public Neo::Singleton<ObjectAccessor, Neo::ClassLevelLockable<ObjectAccessor, ACE_Thread_Mutex> >
{

    friend class Neo::OperatorNew<ObjectAccessor>;
    ObjectAccessor();
    ~ObjectAccessor();
