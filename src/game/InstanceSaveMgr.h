...
class NEO_DLL_DECL InstanceSaveManager : public Neo::Singleton<InstanceSaveManager, Neo::ClassLevelLockable<InstanceSaveManager, ACE_Thread_Mutex> >
{
...
#define sInstanceSaveManager Neo::Singleton<InstanceSaveManager>::Instance()
#endif
