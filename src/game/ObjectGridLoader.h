...
#ifndef NEO_OBJECTGRIDLOADER_H
#define NEO_OBJECTGRIDLOADER_H
...
class NEO_DLL_DECL ObjectGridLoader
{
...
class NEO_DLL_DECL ObjectGridUnloader
{
    public:
...
class NEO_DLL_DECL ObjectGridStoper
{
    public:
...
class NEO_DLL_DECL ObjectGridCleaner
{
    public:
