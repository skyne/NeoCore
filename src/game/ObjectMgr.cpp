...
void ObjectMgr::LoadCreatureModelInfo()
{
    ...
    //                                                   0            1           2              3               4  
    QueryResult_AutoPtr result = WorldDatabase.Query("SELECT modelid, bounding_radius, combat_reach, gender, modelid_other_gender FROM creature_model_info");
    if( !result )
    {
...
void ObjectMgr::LoadGroups()
{
    ...
    QueryResult_AutoPtr result = CharacterDatabase.Query("SELECT mainTank, mainAssistant, lootMethod, looterGuid, lootThreshold, icon1, icon2, icon3, icon4, icon5, icon6, icon7, icon8, isRaid, leaderGuid FROM groups");
...
void ObjectMgr::LoadAccessRequirements()
{
    ...
    //                                                0       1          2       3      4        5               6
    QueryResult_AutoPtr result = WorldDatabase.Query("SELECT id, level_min, level_max, item, item2, quest_done, quest_failed_text FROM access_requirement");
    if( !result )
    {
