...
bool Guild::create(Player* leader, std::string gname)
{
    ...
    CreateRank(lSession->GetNeoString(LANG_GUILD_MASTER),  GR_RIGHT_ALL);
    CreateRank(lSession->GetNeoString(LANG_GUILD_OFFICER), GR_RIGHT_ALL);
    CreateRank(lSession->GetNeoString(LANG_GUILD_VETERAN), GR_RIGHT_GCHATLISTEN | GR_RIGHT_GCHATSPEAK);
    CreateRank(lSession->GetNeoString(LANG_GUILD_MEMBER),  GR_RIGHT_GCHATLISTEN | GR_RIGHT_GCHATSPEAK);
    CreateRank(lSession->GetNeoString(LANG_GUILD_INITIATE),GR_RIGHT_GCHATLISTEN | GR_RIGHT_GCHATSPEAK);
