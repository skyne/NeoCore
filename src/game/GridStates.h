...
#ifndef NEO_GRIDSTATES_H
#define NEO_GRIDSTATES_H

#include "Map.h"
#include "Object.h"

class NEO_DLL_DECL GridState
{
    public:
#ifdef NEO_DEBUG
...
class NEO_DLL_DECL InvalidState : public GridState
{
    public:
...
class NEO_DLL_DECL ActiveState : public GridState
{
    public:
...
class NEO_DLL_DECL IdleState : public GridState
{
    public:
...
class NEO_DLL_DECL RemovalState : public GridState
{
    public:
