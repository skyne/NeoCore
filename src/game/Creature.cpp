...
void Creature::DoFleeToGetAssistance()
{
    ...
    if (radius >0)
    {
        ...
        Neo::CreatureLastSearcher<Neo::NearestAssistCreatureInCreatureRangeCheck> searcher(pCreature, u_check);
...
Unit* Creature::SelectNearestTarget(float dist) const
{
...

    {
        ...
        Neo::UnitLastSearcher<Neo::NearestHostileUnitInAttackDistanceCheck> searcher(target, u_check);
    ...
    if (!m_AlreadyCallAssistance && getVictim() && !isPet() && !isCharmed())
    {
        ...
        if (radius > 0)
        {
...

            {
                ...
                Neo::CreatureListSearcher<Neo::AnyAssistCreatureInRangeCheck> searcher(assistList, u_check);
