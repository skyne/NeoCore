...
void WorldSession::HandleMovementOpcodes(WorldPacket & recv_data )
{
    ...
    if (!Neo::IsValidMapCoord(movementInfo.x, movementInfo.y, movementInfo.z, movementInfo.o))
        return;
    ...
    if (MovementFlags & MOVEMENTFLAG_ONTRANSPORT)
    {
        ...
        if (!Neo::IsValidMapCoord(movementInfo.x+movementInfo.t_x, movementInfo.y+movementInfo.t_y,
