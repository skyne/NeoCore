...
#ifndef NEO_MOVEMENTGENERATOR_H
#define NEO_MOVEMENTGENERATOR_H
...
class NEO_DLL_SPEC MovementGenerator
{
    public:
...
class NEO_DLL_SPEC MovementGeneratorMedium : public MovementGenerator
{
    public:
