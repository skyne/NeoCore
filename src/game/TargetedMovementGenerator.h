...
#ifndef NEO_TARGETEDMOVEMENTGENERATOR_H
#define NEO_TARGETEDMOVEMENTGENERATOR_H
...
class NEO_DLL_SPEC TargetedMovementGeneratorBase
{
    public:
...
template<class T>
class NEO_DLL_SPEC TargetedMovementGenerator
