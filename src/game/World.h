...
{
    MAINTENANCE_TASK_DISTRIBUTE_ARENA_POINTS = 1,
    MAINTENANCE_TASK_ERASE_CORPSES           = 2,
    MAINTENANCE_TASK_RELOAD_ALL              = 4,
    MAINTENANCE_TASK_DISTRIBUTE_PVP_RANKS    = 8,
    MAINTENANCE_TASK_UNLOAD_MAPS             = 16,
};
...
enum WorldConfigs
{
    ...
    CONFIG_MMAP_ENABLED,
    CONFIG_SERVER_LOCKDOWN,
    CONFIG_SERVER_MAINTENANCE_TASKS,
    CONFIG_SERVER_LOCKDOWN_INTERVAL_DAYS,
    CONFIG_SERVER_LOCKDOWN_LENGTH_MINUTES,
    CONFIG_VALUE_COUNT
};
...
enum Rates
{
	...
	//class specific xp rate section start
	RATE_XP_KILL_HUMAN,
	RATE_XP_KILL_ORC,
	RATE_XP_KILL_TROLL,
	RATE_XP_KILL_DWARF,
	...
	RATE_XP_QUEST_DWARF,
	RATE_XP_QUEST_GNOME,
	RATE_XP_QUEST_TAUREN,
	RATE_XP_QUEST_UNDEAD,
	RATE_XP_QUEST_NELF,
	RATE_XP_QUEST_BELF,	
	RATE_XP_QUEST_DRAE,	
	RATE_XP_QUEST_DEFAULT,
	//end section
    
	//class specific xp rate section start
	RATE_XP_EXPLORE_HUMAN,
	RATE_XP_EXPLORE_ORC,
	RATE_XP_EXPLORE_TROLL,
	RATE_XP_EXPLORE_DWARF,
	RATE_XP_EXPLORE_GNOME,
	RATE_XP_EXPLORE_TAUREN,
	RATE_XP_EXPLORE_UNDEAD,
	RATE_XP_EXPLORE_NELF,
	RATE_XP_EXPLORE_BELF,	
	RATE_XP_EXPLORE_DRAE,	
	RATE_XP_EXPLORE_DEFAULT,
	//end section

	RATE_XP_RAF_MULTIPLIER,
    RATE_XP_PAST_70,
...
class World
{
	...
	//used World DB's supported core
	uint8 LoadDBSupportedCoreVersion();
        ...
        bool IsLockedDown() { return m_locked_down; }
        void SetLockdownState(bool apply) { m_locked_down = apply; }
        void LockdownMsg();
		std::string CannString;
    ...
    private:
        ...
        uint64 m_server_lockdown_time;
        bool m_locked_down;
        bool m_maintenance_done;
...
#define sWorld Neo::Singleton<World>::Instance()
#endif
/// @}
