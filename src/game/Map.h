...
struct RGuard
{
    ...
    Neo::GeneralLock<LOCK_TYPE> i_lock;
};
...
typedef Neo::SingleThreaded<GridRWLock>::Lock NullGuard;
//******************************************
...
class NEO_DLL_SPEC Map : public GridRefManager<NGridType>, public Neo::ObjectLevelLockable<Map, ACE_Thread_Mutex>
{
    ...
    protected:
        ...
        typedef Neo::ObjectLevelLockable<Map, ACE_Thread_Mutex>::Lock Guard;
...
class NEO_DLL_SPEC InstanceMap : public Map
{
    public:
...
class NEO_DLL_SPEC BattleGroundMap : public Map
{
    public:
...
{
    float x_off, y_off;
    CellPair p(Neo::ComputeCellPair(x, y, x_off, y_off));
    Cell cell(p);
