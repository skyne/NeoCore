...
class NEO_DLL_SPEC UnitBaseEvent
{
    private:
        uint32 iType;
    public:
...
class NEO_DLL_SPEC ThreatRefStatusChangeEvent : public UnitBaseEvent
{
    private:
...
class NEO_DLL_SPEC ThreatManagerEvent : public ThreatRefStatusChangeEvent
{
    private:
