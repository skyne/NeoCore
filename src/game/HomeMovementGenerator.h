...
#ifndef NEO_HOMEMOVEMENTGENERATOR_H
#define NEO_HOMEMOVEMENTGENERATOR_H
...
template < class T >
class NEO_DLL_SPEC HomeMovementGenerator;

template <>
class NEO_DLL_SPEC HomeMovementGenerator<Creature>
